...
* 2018년 8월 30일 업데이트. 발표.
  * 핵심 내용.
    * 모든 컴포넌트를 philgo-api-chat-component git repo 에 저장하고, subtree 로 작업을 한다.
    * 뿐만아니라 추가되는 모든 모듈/컴포넌트/서비스 단위를 philgo-api-xxxx 와 같이 git repo 에 저장하고, subtree 로 작업을 한다.
    * 질문게시판과 자유게시판에 채팅 연동.
